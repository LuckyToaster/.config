...
int main(void) {
    ...
    while (!WindowShouldClose()) {
        ...
        BeginDrawing();
            ...
            DrawText(TextFormat("Player x: %02i", player.x), 20, 145, 20, BLACK);
            DrawText(TextFormat("Player y: %02i", player.y), 20, 150, 20, BLACK);
            DrawText(TextFormat("FPS: %02i", GetFPS()), 20, 175, 20, BLACK);
        EndDrawing();
    }
