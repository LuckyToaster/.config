...
int main(void) {
    ...
    while (!WindowShouldClose()) {
        ...
        BeginDrawing();
            ...
            DrawRectangle( 10, 10, 250, 155, Fade(SKYBLUE, 0.5f));
            DrawRectangleLines( 10, 10, 250, 155, BLUE);
            ...
            DrawText(TextFormat("Player x: %02i", player.x), 20, 120, 20, DARKGRAY);
            DrawText(TextFormat("Player y: %02i", player.y), 20, 140, 20, DARKGRAY);
        EndDrawing();
    }
