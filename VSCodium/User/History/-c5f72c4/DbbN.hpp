...
class Projector {
    public:
        ...
        static mat<float> rotateX(mat<float> m, double angle);
        static mat<float> rotateY(mat<float> m, double angle);
        static mat<float> rotateZ(mat<float> m, double angle);
        static mat<float> rotateXYZ(mat<float> m, double x_angle, double y_angle, double z_angle);
};
...
mat<float> Projector::getXRotationMat(double angle) {
    mat res = {
        {1.0, 0.0, 0.0},
...
mat Projector::getYRotationMat(double angle) {
    mat res = {
...
mat Projector::rotateX(mat v, double angle ) {
    return v * getXRotationMat(angle);
}

mat Projector::rotateY(mat v, double angle) {
    return v * getYRotationMat(angle);
}

mat Projector::rotateZ(mat v, double angle) {
    return v * getZRotationMat(angle);
}
