...
Screen::Screen(const char* name, int width, int height) {
    ...
    glfwWindowHint(GLFW_CONTEXT_VERSION_MAJOR, 2); // Request at least OpenGL 3.3
    ...
    glClearColor(1.0f, 1.0f, 1.0f, 1.0f); // Set background color to black (or any color you prefer)
