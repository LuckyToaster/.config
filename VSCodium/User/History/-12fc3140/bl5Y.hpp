...
vec3 glmProject(vec4 p, vec3 cam, vec3 orientation, vec3 surface) {
    if ((cam.x == 0.0f && cam.y == 0.0f && cam.z == 0.0f) || (orientation.x == 0.0f && orientation.y == 0.0f && orientation.z == 0.0f)) {
